...
function openSurprise() {
    ...
    // ✅ Play music immediately (browser sees user interaction)
    ...
    newPage.document.write(`
        ...
        <head>
            ...
            <style>
                ...
                p { font-size:1rem; line-height:1.6; margin-top:20px; color:#444; }
                ...
                .side-photo { position:absolute; top:50%; width:180px; height:180px; border:5px solid #ff66b2; border-radius:20px; overflow:hidden; 
                ...
                /* Responsive */
                @media (max-width:768px){ .side-photo { width:140px; height:140px; } h1{ font-size:1.6rem;} p{ font-size:0.9rem; } }
                @media (max-width:480px){ .side-photo{ display:none; } h1{ font-size:1.4rem;} p{ font-size:0.85rem;} }
            </style>
        </head>
        <body>
